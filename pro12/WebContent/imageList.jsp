...
font-family:'돋음',Dotum;font-size:12px;line-height:100px;
...
.lst_type li span{color:blue; margin-left:330px;font-family:'돋음',Dotum;font-size:14px;}
</Style>
<meta charset="UTF-8">
...
%>		
	<li>
		...
		<img src='image/duke.png' width='90' alt='' /></a>
		<a href='#'><strong>이미지 이름: 듀크</strong></a>
